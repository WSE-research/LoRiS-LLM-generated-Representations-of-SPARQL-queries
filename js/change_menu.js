...
waitForElm('#MainMenu').then((elm) => {
    ...
    if (parent.window.document.getElementById("WSElogo") == null) {
        ...
        new_logo.innerHTML = `
        <a href="https://wse-research.org/?utm_source=loris&utm_medium=header" title="Brought to you by the WSE research group at the Leipzig University of Applied Sciences. See our GitHub team page for more projects and tools." target="_blank">
